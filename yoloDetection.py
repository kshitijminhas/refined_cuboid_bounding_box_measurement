...
def getBoundingBoxes(dataloader):
    ...
    for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
        ...
        boxes.extend([[i[:4] for i in detections[0]]])
        # import pdb; pdb.set_trace()

    return imgs, img_detections, boxes

def drawBoxes(imgs, img_detections, classes):
...
if __name__ == "__main__":
    ...
    imgs, img_detections, boxes = getBoundingBoxes(dataloader)
    print(boxes)
    drawBoxes(imgs, img_detections, classes)
